...
description: "盈透覆盖全球市场、交易成本低，但大陆用户开户最大的门槛是境外地址证明。本文讲开户准备、证明方案和从 0 到 1 的完整申请流程。"
readMinutes: 14
tags: ["美股券商", "盈透"]
featured: false
---
...
![](/content-assets/ibkr-account/01-png.webp)
...
![](/content-assets/ibkr-account/02-png.webp)

然后点击右上角的语言标识，切换到中文。

![](/content-assets/ibkr-account/03-png.webp)
...
![](/content-assets/ibkr-account/04-png.webp)

然后它这里会弹出针对中国大陆用户的提示，要求必须提供海外地址证明。我们点击继续。

![](/content-assets/ibkr-account/05-png.webp)

上面会有一个确认电子邮箱的提示，我们点击确认。

![](/content-assets/ibkr-account/06-png.webp)

邮箱里会收到一个确认码，填写到输入框里，完成确认就好。

![](/content-assets/ibkr-account/07-png.webp)

账户类型我们就选择个人账户。

拉到底部，语言选择简体中文，点击开始申请。

![](/content-assets/ibkr-account/08-png.webp)
...
![](/content-assets/ibkr-account/09-png.webp)

接下来就是填写你英文拼音的姓氏和名字。

填好后点击下一步。

![](/content-assets/ibkr-account/10-png.webp)

出生日期如实填写，和你身份证上面的要保持一致。

![](/content-assets/ibkr-account/11-png.webp)
...
![](/content-assets/ibkr-account/12-png.webp)

主要国籍信息选择中国，点击下一步。

![](/content-assets/ibkr-account/13-png.webp)

电话号码对应的国家代码选择 CN，也就是+86，输入你的手机号，点击下一步。

![](/content-assets/ibkr-account/14-png.webp)

然后接受一下手机验证码，盈透不存在大陆手机号收不到验证码的问题，很方便。点击下一步。

![](/content-assets/ibkr-account/15-png.webp)

基础货币选择美元，点击下一步。

![](/content-assets/ibkr-account/16-png.webp)

雇佣情况最好选择受雇，最好不要选择自由职业，可能涉及到额外审核。

下面的选择否，点击下一步。

![](/content-assets/ibkr-account/17-png.webp)
...
![](/content-assets/ibkr-account/18-png.webp)

接着必须的监管信息，就是问你是不是某个公司的股东或者管理层，直接选择否，点击下一步。

![](/content-assets/ibkr-account/19-png.webp)

财富来源根据实际情况勾选一下，一般就是工作收入、市场投资交易、利息股息收入这几项，点击下一步。

![](/content-assets/ibkr-account/20-png.webp)

账户类型这里，不要按照图上的选保证金，最好先选择现金账户，因为我看到有些人说如果选择保证金、期权账户的话，可能会涉及到额外人工审核。

如果你后续需要使用券商margin融资功能的话，等你开户成功之后，再升级到保证金账户，也是没问题的。

![](/content-assets/ibkr-account/21-png.webp)

收入和资产净值根据实际情况填写，你可以稍微填高一些。

![](/content-assets/ibkr-account/22-png.webp)

投资目标就选择资产保值和增长。

![](/content-assets/ibkr-account/23-png.webp)

交易许可这里，我们只选择股票。

期权、预测市场、债券、期货都不要选，点击下一步。

![](/content-assets/ibkr-account/24-png.webp)

投资经验就根据自己实际情况选择。

![](/content-assets/ibkr-account/25-png.webp)
...
![](/content-assets/ibkr-account/26-png.webp)

下面就是安全问题，根据自己实际情况设置一下，找回密码的时候用得到。

![](/content-assets/ibkr-account/27-png.webp)

通过什么途径得知的IBKR，我们就勾选推荐项目。

![](/content-assets/ibkr-account/28-png.webp)

税务信息这里，婚姻情况、家属人数如实填写，居住地选择中国，纳税识别号就是你的身份证号，点击下一步。

![](/content-assets/ibkr-account/29-png.webp)

身份证件签发国家选择中国，证件类型按照图上的选，就是身份证，证件号码就是身份证号码，有效期如实填写，点击下一步。

![](/content-assets/ibkr-account/30-png.webp)

然后确认信息是否填写正确，没问题就点击下一步。

![](/content-assets/ibkr-account/31-png.webp)

接着勾选一下上面两个条款，都选择是。下面把你的姓名按照格式输进去，点击下一步。

![](/content-assets/ibkr-account/32-png.webp)

然后就到了协议披露的环节，全都勾选同意，然后往下拉，和刚才一样签名，点击提交。

![](/content-assets/ibkr-account/33-png.webp)

然后盈透会提示你还需要更多的信息，我们点击继续申请。

![](/content-assets/ibkr-account/34-png.webp)

这里其实就已经完成主体的开户申请流程了，但是还有两个必做项。

![](/content-assets/ibkr-account/35-png.webp)

一个是回答问题，很简单，我们直接选择是，然后点击继续。

![](/content-assets/ibkr-account/36-png.webp)

剩下的就是提交海外地址证明了，我们点击上传文件。

![](/content-assets/ibkr-account/37-png.webp)
