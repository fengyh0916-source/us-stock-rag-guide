      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
          ...
          <div className="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-400 sm:text-base">
                聚焦“用户有没有真正用起来”：提问、回答质量、内容承接和反馈。PV、来源渠道与设备分布在 Vercel Analytics 查看。
              </p>
            </div>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex w-fit items-center gap-2 rounded-full border border-cyan-300/25 bg-cyan-300/10 px-4 py-2 text-sm font-semibold text-cyan-100 transition hover:border-cyan-200/50 hover:bg-cyan-300/15"
            >
              查看 PV / 访客来源
        ...
        <section className="mt-6 flex flex-col gap-3 rounded-2xl border border-white/10 bg-white/[0.025] p-5 text-xs leading-5 text-slate-500 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-start gap-2">
            ...
            <p>这里只保存匿名行为指标，不保存问题原文、邮箱、IP 或持仓。PV 使用 Vercel 的匿名统计口径。</p>
          </div>
